...
It is very hard to formalize any criterion that could reliably classify aliases according to user intent.
...
However, when repeating the analyses described in the remainder of this paper on the subset of aliases explictily labelled as dotfiles, we found that relative frequencies remained virtually unchanged and the overall picture stayed exactly the same.
