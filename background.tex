...
%  (\TODO references)
The POSIX family of standards defines a Shell Command Language~\cite{posix_standard}, whose standard implementation is still the \verb|sh| utility, but there exist a wide variety of popular POSIX-compliant shells like \verb|bash| or \verb|zsh|.
