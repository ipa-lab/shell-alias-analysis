...
The top 3 of aliases (or 6 depending on whether you would want to count basic synonyms separately) make up more than \per{95} of the \per{55.4}: \verb|{dir, vdir}| (\per{21.7}), \verb|ls| (\per{26.5}), and \verb|{grep, fgrep, egrep}| (\per{49.3}).
...
To quickly summarize the extent within default arguments: \num{64497} aliases define safety and interactivity arguments (or \per{28.7} of overall default argument aliases without color options).
