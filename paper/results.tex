...
\TODO: regular shortcuts?

\paragraph{\bf Renaming Commands}

\TODO: Renaming Commands as a practice? occurs in 10-14 per of aliases! could subsume autocorrect? and even subcommand shortcuts?

\paragraph{\bf Correcting Misspellings}

A special case of renaming occurs when the new name is a common misspelling of the renamed command.
...
Noticeably, we found \num{194850} aliases (\per{8.84}) that are purely abbreviations of subcommands, without adding any additional arguments.
