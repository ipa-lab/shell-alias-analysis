...
renaming: giving a new name, but not otherwise changing the semantics of the command
redefine: declare an alias of the same name as the command that calls the command with certain arguments
shortcut: defines a name for a commonly used invocation of a command with certain arguments
scripting: by composing multiple commands we effectively create a mini-script
...
scripting:
aliases often defined for inline mini scripts
summary of operators etc
pipe most interesting, classic unix, flow diagram
an interesting phenomenon is chains of subcommands, most commonly for apt-get, brew etc
