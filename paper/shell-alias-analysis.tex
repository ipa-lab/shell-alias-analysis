...
There are \num{244872} aliases in our data\-set (\per{11.11}) that merely give a new name to a command, without adding any arguments, and without the name belonging to a different command (that would be a substitution, see below).
...
\begin{figure*}
	\centering    
	\includegraphics[width=0.73\linewidth]{fig-flow_250.png}
	\caption{Flow diagram of the top 250 pipelines with three commands that make up at least \per{10} of one command's usage}
	\label{fig:flow}
\end{figure*}
